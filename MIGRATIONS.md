...
php neuron cms:migrate --target=20241105120000

# Dry run to see what would be executed
php neuron cms:migrate --dry-run
```
...
```bash
php neuron cms:migrate:rollback
```
...
php neuron cms:migrate:rollback --target=20241105120000 --force

# Dry run to see what would be rolled back
php neuron cms:migrate:rollback --dry-run
```
...
# Run specific seeder
php neuron cms:migrate:seed --seed=UserSeeder
```
