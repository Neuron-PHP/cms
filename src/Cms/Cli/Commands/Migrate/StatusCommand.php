...
namespace Neuron\Cms\Cli\Commands\Migrate;

use Neuron\Cli\Commands\Command;
use Neuron\Cms\Database\MigrationManager;
...
class StatusCommand extends Command
{
	...
	public function execute(): int
	{
		...
		if( !is_dir( $manager->getMigrationsPath() ) )
		{
			...
			$this->output->info( 'Run: neuron cms:migrate:create YourFirstMigration' );
			return 1;
		}
