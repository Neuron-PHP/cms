 ...
 * autowired safely whether or not the package is installed. When donations are
 * not enabled (package missing or no secret key configured) it returns null
 * and the donation routes degrade gracefully.
 *
...
class PaymentGatewayFactory
{
	...
	/**
	 * Build the configured gateway, or null when donations are not enabled.
	 *
