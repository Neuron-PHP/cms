				...
				<div class="card mb-4">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<input type="url" class="form-control" id="external_url" name="external_url" placeholder="https://example.com/event">
					...
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<select class="form-select" id="registration_visibility" name="registration_visibility">
								<option value="public" selected>Public (anyone can register)</option>
						...
						<div class="mb-3">
							...
							<input type="number" class="form-control" id="capacity" name="capacity" min="1" placeholder="Unlimited">
