			...
			<form method="POST" action="<?= route_path('admin_posts_update', ['id' => $post->getId()]) ?>" id="post-form">
				...
				<div class="mb-3">
					...
					<small class="form-text text-muted">
						Use shortcodes for dynamic content: <code>[latest-posts limit="5"]</code> or <code>[team slug="staff"]</code>
					</small>
				</div>
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="meta_title" name="meta_title" value="<?= htmlspecialchars( $post->getMetaTitle() ?? '' ) ?>" maxlength="60">
							<small class="form-text text-muted">60 chars max. Leave blank to use the post title.</small>
						</div>
						<div class="mb-3">
							<label for="meta_description" class="form-label">Meta Description</label>
							<textarea class="form-control" id="meta_description" name="meta_description" rows="3" maxlength="160"><?= htmlspecialchars( $post->getMetaDescription() ?? '' ) ?></textarea>
							<small class="form-text text-muted">160 chars max. Falls back to the excerpt.</small>
						</div>
						<div class="mb-3 mb-0">
							<label for="meta_keywords" class="form-label">Meta Keywords</label>
							<input type="text" class="form-control" id="meta_keywords" name="meta_keywords" value="<?= htmlspecialchars( $post->getMetaKeywords() ?? '' ) ?>">
