<?php
/**
 * Buyer receipt email for a completed store order.
 *
...
<head>
	...
	<style>
		...
		.total { font-size: 18px; font-weight: bold; color: #1e7e34; }
...
<body>
	<div class="email-container">
		...
		<div class="email-body">
			<p>Dear <?= htmlspecialchars( $payerName !== '' ? (string) $payerName : 'Customer' ) ?>,</p>
			<p>Thank you for your order. This message confirms order #<?= htmlspecialchars( (string) $orderId ) ?>:</p>
			<table>
				<thead>
					<tr>
						<th>Item</th>
